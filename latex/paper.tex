...
if (is_bpsk) begin // BPSK
  ...
  \section{Experiment Results on SDR}
    ...
    \begin{figure*}[!t]
      \setlength{\tabcolsep}{2pt}
      \subfloat[A BPSK packet (with \textsf{Rx\_data\_tuser} is high).]{\includegraphics{_tikz_ila_BPSK-crop.pdf}}\\
      \subfloat[A QPSK packet (with \textsf{Rx\_data\_tuser} is low).]{\includegraphics{_tikz_ila_QPSK-crop.pdf}}\\
