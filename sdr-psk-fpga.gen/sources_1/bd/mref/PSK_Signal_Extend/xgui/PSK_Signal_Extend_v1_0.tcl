...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "USE_I_STRM" -parent ${Page_0}
...
proc update_PARAM_VALUE.USE_I_STRM { PARAM_VALUE.USE_I_STRM } {
	# Procedure called to update USE_I_STRM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.USE_I_STRM { PARAM_VALUE.USE_I_STRM } {
	# Procedure called to validate USE_I_STRM
	return true
}
...
proc update_MODELPARAM_VALUE.USE_I_STRM { MODELPARAM_VALUE.USE_I_STRM PARAM_VALUE.USE_I_STRM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.USE_I_STRM}] ${MODELPARAM_VALUE.USE_I_STRM}
}
