...
module Tx_imp_1IUYQQO
  ...
  top_Bits_Flatten_0_0 Bits_Flatten_0
       (.bypass(Packetizer_0_out_tuser),
        .clk_in(clk_1M024),
        .clk_out(clk_2M048_1),
        .in(Packetizer_0_out_tdata),
        .out(Bits_Flatten_0_out));
  ...
  top_Tx_Data_0_0 Tx_Data_0
       (.MODE_CTRL(MODE_CTRL_1),
        ...
        .payload_length(Tx_Data_0_payload_length),
        .pkt_sent(Packetizer_0_out_tuser),
        .rst_n(s_axis_aresetn_1));
endmodule

(* CORE_GENERATION_INFO = "top,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=77,numReposBlks=62,numNonXlnxBlks=0,numHierBlks=15,maxHierDepth=3,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=22,numPkgbdBlks=2,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "top.hwdef" *) 
module top
   (AD9361_DATACLK,
    AD9361_FBCLK,
    AD9361_P0_D,
