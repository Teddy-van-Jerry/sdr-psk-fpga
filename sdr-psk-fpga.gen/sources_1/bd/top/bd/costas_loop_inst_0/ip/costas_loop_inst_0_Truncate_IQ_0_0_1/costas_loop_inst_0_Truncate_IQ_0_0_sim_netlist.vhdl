...
begin
  I_tdata(15 downto 0) <= \^iq_tdata\(73 downto 58);
  I_tvalid <= \^iq_tvalid\;
  Q_tdata(15 downto 0) <= \^iq_tdata\(33 downto 18);
  Q_tvalid <= \^iq_tvalid\;
  \^iq_tdata\(73 downto 58) <= IQ_tdata(73 downto 58);
  \^iq_tdata\(33 downto 18) <= IQ_tdata(33 downto 18);
  \^iq_tvalid\ <= IQ_tvalid;
end STRUCTURE;
