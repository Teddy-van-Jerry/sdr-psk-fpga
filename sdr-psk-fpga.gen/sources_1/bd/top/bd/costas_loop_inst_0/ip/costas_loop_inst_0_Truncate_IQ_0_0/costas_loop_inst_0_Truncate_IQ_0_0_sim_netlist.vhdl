...
begin
  I_tdata(15 downto 0) <= \^iq_tdata\(61 downto 46);
  I_tvalid <= \^iq_tvalid\;
  Q_tdata(15 downto 0) <= \^iq_tdata\(21 downto 6);
  Q_tvalid <= \^iq_tvalid\;
  \^iq_tdata\(61 downto 46) <= IQ_tdata(61 downto 46);
  \^iq_tdata\(21 downto 6) <= IQ_tdata(21 downto 6);
  \^iq_tvalid\ <= IQ_tvalid;
end STRUCTURE;
