...
module top_Tx_Data_0_0(clk, MODE_CTRL, data_tdata, data_tvalid, 
  data_tready, data_tlast, data_tuser)
/* synthesis syn_black_box black_box_pad_pin="clk,MODE_CTRL[3:0],data_tdata[7:0],data_tvalid,data_tready,data_tlast,data_tuser" */;
  input clk;
  input [3:0]MODE_CTRL;
