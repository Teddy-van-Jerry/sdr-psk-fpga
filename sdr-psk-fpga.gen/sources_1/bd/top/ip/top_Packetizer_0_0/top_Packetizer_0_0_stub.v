...
module top_Packetizer_0_0(clk, rst_n, MODE_CTRL, payload_length, I_tdata, 
  ...
  pld_vld, pkt_sent)
/* synthesis syn_black_box black_box_pad_pin="clk,rst_n,MODE_CTRL[3:0],payload_length[15:0],I_tdata[7:0],I_tvalid,I_tready,I_tlast,I_tuser,O_tdata[7:0],O_tvalid,O_tready,O_tlast,O_tuser,hdr_vld,pld_vld,pkt_sent" */;
  input clk;
  input rst_n;
  input [3:0]MODE_CTRL;
