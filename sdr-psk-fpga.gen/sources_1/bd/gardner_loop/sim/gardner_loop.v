...
module Interpolation_imp_I1S4YE
   (I_tdata,
    I_tvalid,
    I_up2,
    Q_tdata,
  ...
  gardner_loop_Gardner_IQ_Pre_0_0 Gardner_IQ_Pre_0
       (.I_in_tdata(I_1_TDATA),
        ...
        .clk(clk_32d768_1));
  gardner_loop_fir_compiler_0_0 fir_compiler_I
       (.aclk(clk_32d768_1),
  ...
  gardner_loop_fir_compiler_I_2 fir_compiler_Q
       (.aclk(clk_32d768_1),
...
module Timing_Error_imp_2RVXWT
   (I,
    Q,
    clk_32M768,
    error_n,
  ...
  gardner_loop_Gardner_Timing_Error_0_0 Gardner_Timing_Error_0
       (.I(c_shift_ram_I2_Q),
        ...
        .is_bpsk(is_bpsk_1));
  gardner_loop_c_shift_ram_0_0 c_shift_ram_I1
       (.CLK(clk_32d768_1),
        .D(Interpolation_Ix2_tdata),
        .Q(c_shift_ram_I1_Q));
  gardner_loop_c_shift_ram_I1_1 c_shift_ram_I2
       (.CLK(clk_32d768_1),
        .D(c_shift_ram_I1_Q),
        .Q(c_shift_ram_I2_Q));
  gardner_loop_c_shift_ram_I1_0 c_shift_ram_Q1
       (.CLK(clk_32d768_1),
        .D(Interpolation_Qx2_tdata),
        .Q(c_shift_ram_Q1_Q));
  gardner_loop_c_shift_ram_Q1_0 c_shift_ram_Q2
       (.CLK(clk_32d768_1),
        .D(c_shift_ram_Q1_Q),
        .Q(c_shift_ram_Q2_Q));
endmodule

(* CORE_GENERATION_INFO = "gardner_loop,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gardner_loop,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "gardner_loop.hwdef" *) 
module gardner_loop
   (GARDNER_SHIFT,
    I_1M,
    I_tdata,
