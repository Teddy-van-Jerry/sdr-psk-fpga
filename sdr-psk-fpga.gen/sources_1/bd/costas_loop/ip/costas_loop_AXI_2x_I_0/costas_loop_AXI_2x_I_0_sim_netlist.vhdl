...
-- Command     : write_vhdl -force -mode funcsim -rename_top costas_loop_AXI_2x_I_0 -prefix
--               costas_loop_AXI_2x_I_0_ costas_loop_inst_0_AXI_2x_Q_0_sim_netlist.vhdl
...
entity costas_loop_AXI_2x_I_0 is
  ...
  attribute NotValidForBitStream of costas_loop_AXI_2x_I_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of costas_loop_AXI_2x_I_0 : entity is "costas_loop_inst_0_AXI_2x_Q_0,AXI_2x,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of costas_loop_AXI_2x_I_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of costas_loop_AXI_2x_I_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of costas_loop_AXI_2x_I_0 : entity is "AXI_2x,Vivado 2022.2";
end costas_loop_AXI_2x_I_0;

architecture STRUCTURE of costas_loop_AXI_2x_I_0 is
